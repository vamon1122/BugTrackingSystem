            ...
            if (!Data.OfflineMode)
            {
                ...
                try
                {
                    using (SqlConnection conn = new SqlConnection(Data.OnlineConnStr))
                    {
                        ...
                        SqlCommand CheckOnlineDb = new SqlCommand("SELECT * FROM t_Tags WHERE Id = @Id", conn);
                        ...
                        if (!OnlineTagExists)
                        {
                            SqlCommand CreateTag = new SqlCommand("INSERT INTO t_Tags VALUES (@Id, @BugId, " +
            ...
            else
            {
                ...
                try
                {
                    using (SqlConnection conn = new SqlConnection(Data.OnlineConnStr))
                    {
                        ...
                        SqlCommand GetTag = new SqlCommand("SELECT * FROM t_Tags WHERE Id = @Id", conn);
                        GetTag.Parameters.Add(new SqlParameter("Id", _Id));
