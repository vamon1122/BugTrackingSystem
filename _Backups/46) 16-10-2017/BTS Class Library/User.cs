    ...
    public class User
    {
        ...
        private bool Validate()
        {
            ...
            if(Gender != Convert.ToChar("\0"))
            {
                ...
                { _ErrMsg = Gender.ToString() + " is not a valid gender"; return false; }
            }

            if (Username == null) { _ErrMsg = "User has not been given a username"; return false; }
            if (Username.Length > 20) { _ErrMsg = "Username exceeds 50 characters"; return false; }
            ...
            if (EMail.Length > 254) { _ErrMsg = "Email address exceeds 254 characters"; return false; }
