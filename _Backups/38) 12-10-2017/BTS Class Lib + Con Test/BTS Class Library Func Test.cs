...
namespace BTS_Class_Lib___Con_Test
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                Data.UserFriendlyError(MyBug.ErrMsg);
            }
            ...
            for (int i = 1; i < 11; i++)
            {
                ...
                {
                    Data.UserFriendlyError(MyNote.ErrMsg);
                }
            ...
            for (int i = 1; i < 2; i++)
            {
                ...
                {
                    Data.UserFriendlyError(MyAssignee.ErrMsg);
                }
