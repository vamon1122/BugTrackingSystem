    ...
    public partial class Bug
    {
        public class Tag
        {
            ...
            public bool Create()
            {
                ...
                {
                    _ErrMsg = "Error while creating tag on local database: " + e;
                    return false;
                }
                ...
                {
                    _ErrMsg = "Error while creating tag on online database: " + e;
                    return false;
                }
            ...
            private bool Get()
            {
                ...
                {
                    _ErrMsg = "Error while getting tag from local database: " + e;
                    return false;
                }
                ...
                {
                    _ErrMsg = "Error while getting tag from online database: " + e;
                    return false;
                }
                return true;
            }
            ...
            public bool Delete()
            {
                ...
                {
                    _ErrMsg = "Error while deleting tag from local database: " + e;
                    return false;
                }
                ...
                {
                    _ErrMsg = "Error while deleting tag from online database: " + e;
                    return false;
                }
