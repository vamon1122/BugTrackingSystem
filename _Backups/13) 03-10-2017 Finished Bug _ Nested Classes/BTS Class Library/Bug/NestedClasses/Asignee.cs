    ...
    public partial class Bug
    {
        public class Assignee
        {
            ...
            public bool Create()
            {
                ...
                {
                    _MyBug._ErrorMsg = "Error while creating assignee on local database: " + e;
                    return false;
                }
                ...
                {
                    _MyBug._ErrorMsg = "Error while creating assignee on online database: " + e;
                    return false;
                }
            ...
            public bool Update()
            {
                try
                {
                    using (SqlConnection conn = new SqlConnection(LocalConnStr))
                    {
                        ...
                        SqlCommand UpdateAssignee = new SqlCommand("UPDATE Assignees SET TimeSpent = @TimeSpent, " +
                            "AccessLevel = @AccessLevel WHERE BugId = @BugId && UserId = @UserId;", conn);
                ...
                {
                    _MyBug._ErrorMsg = "Error while updating assignee on local database: " + e;
                    return false;
                }
                ...
                {
                    _MyBug._ErrorMsg = "Error while updating assignee on online database: " + e;
                    return false;
                }
                return true;
            }
            ...
            private bool Get()
            {
                ...
                {
                    _MyBug._ErrorMsg = "Error while getting assignee from local database: " + e;
                    return false;
                }
                ...
                try
                {
                    using (SqlConnection conn = new SqlConnection(OnlineConnStr))
                    {
                        ...
                        SqlCommand GetAssignee = new SqlCommand("SELECT * FROM t_BTS_Assignees WHERE BugId = @BugId && " +
                            "UserId = UserId;", conn);
                        GetAssignee.Parameters.Add(new SqlParameter("BugId", _MyBug.Id));
                        GetAssignee.Parameters.Add(new SqlParameter("UserId", _MyUser.Id));
                ...
                {
                    _MyBug._ErrorMsg = "Error while getting assignee from online database: " + e;
                    return false;
                }
            ...
            public bool Delete()
            {
                try
                {
                    using (SqlConnection conn = new SqlConnection(LocalConnStr))
                    {
                        ...
                        SqlCommand DeleteAssignee = new SqlCommand("DETETE FROM Assignees WHERE BugId = @BugId && " +
                ...
                {
                    _MyBug._ErrorMsg = "Error while deleting assignee from local database: " + e;
                    return false;
                }
                ...
                {
                    _MyBug._ErrorMsg = "Error while deleting assignee from online database: " + e;
                    return false;
                }
