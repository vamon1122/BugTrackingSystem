...
namespace BTS_Class_Lib___Con_Test
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (DownloadedOrg2.Get()) { Console.WriteLine("Organisation retrieved from local database successfully!"); } else { Data.UserFriendlyError(DownloadedOrg2.ErrMsg); }
            Console.WriteLine();
            Console.ForegroundColor = ConsoleColor.Cyan;
            Console.WriteLine("---------- Validating Downloaded Organisation's Details ----------");
            Console.ResetColor();
            ...
            if (DownloadedOrgMember2.Get()) { Console.WriteLine("Organisation member downloaded successfully!"); } else { Data.UserFriendlyError(DownloadedOrgMember2.ErrMsg); }
            ...
            if (MyOrgMember.Delete()) { Console.WriteLine("Organisation member deleted successfully!"); } else { Data.UserFriendlyError(MyOrgMember.ErrMsg); }
            ...
            if (MyOrgMember.Get()) { Console.WriteLine("Organisation member was somehow downloaded successfully..."); } else { Data.UserFriendlyError(MyOrgMember.ErrMsg); }
