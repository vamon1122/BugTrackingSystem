...
namespace BTS_Class_Library
{
    public class User
    {
        ...
        public bool Update()
        {
            ...
            AppLog.Info(String.Format("UPDATE USER - User {0} created on online database successfully", _Username));
            ...
            AppLog.Info(String.Format("UPDATE USER - User {0} created on local database successfully", _Username));
            return true;
        }
        ...
        public bool Delete()
        {
            ...
            AppLog.Info(String.Format("DELETE USER - User {0} deleted from online database successfully", _Username));
            ...
            AppLog.Info(String.Format("DELETE USER - User {0} deleted from local database successfully", _Username));
