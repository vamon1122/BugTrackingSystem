    ...
    public partial class Bug
    {
        public class Note
        {
            ...
            public bool Create()
            {
                ...
                {
                    _ErrMsg = "Error creating note on local databade: " + e;
                    return false;
                }
                ...
                {
                    _ErrMsg = "Error creating note on online databade: " + e;
                    return false;
                }
            ...
            public bool Update()
            {
                ...
                {
                    _ErrMsg = "Error updating note on local database: " + e;
                    return false;
                }
                ...
                {
                    _ErrMsg = "Error updating note on online database: " + e;
                    return false;
                }
                return true;
            }
            ...
            private bool Get()
            {
                ...
                {
                    _ErrMsg = "Error getting note from local database: " + e;
                    return false;
                }
                ...
                {
                    _ErrMsg = "Error downloading note from online database: " + e;
                    return false;
                }
                return true;
            }
            ...
            public bool Delete()
            {
                ...
                {
                    _ErrMsg = "Error deleting note from local database: " + e;
                    return false;
                }
                ...
                {
                    _ErrMsg = "Error deleting note from online database: " + e;
                    return false;
                }
