    ...
    public partial class Bug
    {
        public class Assignee
        {
            ...
            public bool Create()
            {
                ...
                {
                    _MyBug._ErrMsg = "Error while creating assignee on local database: " + e;
                    return false;
                }
                ...
                {
                    _MyBug._ErrMsg = "Error while creating assignee on online database: " + e;
                    return false;
                }
            ...
            public bool Update()
            {
                ...
                {
                    _MyBug._ErrMsg = "Error while updating assignee on local database: " + e;
                    return false;
                }
                ...
                {
                    _MyBug._ErrMsg = "Error while updating assignee on online database: " + e;
                    return false;
                }
                return true;
            }
            ...
            private bool Get()
            {
                ...
                {
                    _MyBug._ErrMsg = "Error while getting assignee from local database: " + e;
                    return false;
                }
                ...
                {
                    _MyBug._ErrMsg = "Error while getting assignee from online database: " + e;
                    return false;
                }
            ...
            public bool Delete()
            {
                ...
                {
                    _MyBug._ErrMsg = "Error while deleting assignee from local database: " + e;
                    return false;
                }
                ...
                {
                    _MyBug._ErrMsg = "Error while deleting assignee from online database: " + e;
                    return false;
                }
