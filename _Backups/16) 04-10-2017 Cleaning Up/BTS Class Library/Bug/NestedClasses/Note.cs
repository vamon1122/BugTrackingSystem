    ...
    public partial class Bug
    {
        public class Note
        {
            ...
            public bool Create()
            {
                ...
                {
                    MyBug._ErrMsg = "Error creating note on local databade: " + e;
                    return false;
                }
                ...
                {
                    MyBug._ErrMsg = "Error creating note on online databade: " + e;
                    return false;
                }
            ...
            public bool Update()
            {
                ...
                {
                    MyBug._ErrMsg = "Error updating note on local database: " + e;
                    return false;
                }
                ...
                {
                    MyBug._ErrMsg = "Error updating note on online database: " + e;
                    return false;
                }
                return true;
            }
            ...
            private bool Get()
            {
                ...
                {
                    MyBug._ErrMsg = "Error getting note from local database: " + e;
                    return false;
                }
                ...
                {
                    MyBug._ErrMsg = "Error downloading note from online database: " + e;
                    return false;
                }
                return true;
            }
            ...
            public bool Delete()
            {
                ...
                {
                    MyBug._ErrMsg = "Error deleting note from local database: " + e;
                    return false;
                }
                ...
                {
                    MyBug._ErrMsg = "Error deleting note from online database: " + e;
                    return false;
                }
