...
namespace BTS_Class_Library
{
    public class User
    {
        ...
        public bool Create()
        {
            ...
            Log.Info("CREATE USER - User Id: " + _Id);
        ...
        public bool Update()
        {
            ...
            Log.Info("UPDATE USER - User Id: " + _Id);
        ...
        public bool Get()
        {
            ...
            Log.Info("GET USER - User Id: " + _Id);

            if (Data.OfflineMode)
            {
                Log.Info("GET USER - Offline mode is ON. Attempting to get user from local database...");
            ...
            {
                Log.Info("GET USER - Offline mode is OFF. Attempting to download user from online database...");
                try
                {
                    using (SqlConnection conn = new SqlConnection(Data.OnlineConnStr))
                    {
        ...
        public bool Delete()
        {
            ...
            Log.Info("DELETE USER - User Id: " + _Id);
