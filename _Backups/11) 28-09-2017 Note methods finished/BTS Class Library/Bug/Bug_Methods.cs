...
namespace BTS_Class_Library
{
    public partial class Bug
    {
        ...
        public bool Update()
        {
            ...
            try
            {
                using (SqlConnection conn = new SqlConnection(LocalConnStr))
                {
                    ...
                    UpdateBug.Parameters.Add(new SqlParameter("Uploaded", BitConverter.GetBytes(_Uploaded)));
        ...
        private bool Get()
        {
            ...
            {
                _ErrorMsg = "Error downloading bug from the local database: " + e;
                return false;
            }
            ...
            {
                _ErrorMsg = "Error downloading bug from the online database: " + e;
                return false;
            }
        ...
        public bool Delete()
        {
            ...
            {
                _ErrorMsg = "Error deleting bug from the local database: " + e;
                return false;
            }
            ...
            {
                _ErrorMsg = "Error deleting bug from the online database: " + e;
                return false;
            }
