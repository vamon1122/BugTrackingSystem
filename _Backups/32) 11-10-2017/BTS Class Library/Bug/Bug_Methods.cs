...
namespace BTS_Class_Library
{
    public partial class Bug
    {
        ...
        public bool Create()
        {
            ...
            AppLog.Info("<FUNCTION> <CLASS> - Attempting to <function> <class> on <online/local> database...");

            try //Local
            {
                using (SqlConnection conn = new SqlConnection(LocalConnStr))
                {
                    AppLog.Info("<FUNCTION> <CLASS> - Attempting to open connection to <online/local> database...");
                    AppLog.Info("<FUNCTION> <CLASS> - Connection to <online/local> database opened successfully");
                    conn.Open();
                ...
                AppLog.Info(String.Format("<FUNCTION> <CLASS> - <Class> {0} <function> on <online/local> database successfully", Title));
            }
            catch (SqlException e)
            {
                _ErrMsg = "Error whilst creating user on the local database";
            ...
            AppLog.Info("<FUNCTION> <CLASS> - Success!");
            return true;
        }
        ...
        public bool Update()
        {
            ...
            {
                _ErrMsg = "Error updating bug on the local database";
                AppLog.Error(_ErrMsg + ": " + e);
                return false;
            }
