...
namespace BTS_Class_Lib___Con_Test
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            OrgMember DownloadedOrgMember = MyOrg.NewOrgMember(MyUser);
            ...
            OrgMember DownloadedOrgMember2 = MyOrg.NewOrgMember(MyOrgMember.MyUser);
