...
namespace BTS_Class_Library
{
    public partial class Organisation
    {
        ...
        public List<Product> Products { get {
                ...
                AppLog.Info("USER ORG PRODUCTS (Getter) - Attempting to retrieve organisation's products from local database...");
                ...
                else
                {
                    using (SqlConnection conn = new SqlConnection(Data.OnlineConnStr))
                    {
                        ...
                        AppLog.Info("ORG PRODUCTS (Getter) - Products downloaded from online database successfully");
                    }
                }
                return MyProducts;
            }
